...
@Component({
  selector: 'app-medical-campaign',
  templateUrl: './medical-campaign.page.html',
  styleUrls: ['./medical-campaign.page.scss'],
})
export class MedicalCampaignPage implements OnInit {
