...
import { OurProjectsFormPage } from './our-projects-form/our-projects-form.page';
...
export class OurProjectsPage implements OnInit {
  ...
  filterByDateRange() {
    if (this.showCustomDateRange && this.startDate && this.endDate) {
      const startDate = new Date(this.startDate);
      const endDate = new Date(this.endDate);
  ...
  async openModal() {
    const modal = await this.modalController.create({
      component: OurProjectsFormPage, // Modal component to be opened
      componentProps: {
